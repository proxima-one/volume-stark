...
function FRI_QUERY_STEP_V_LEN() { return $FRI_QUERY_STEP_V_LEN; }
function FRI_QUERY_STEP_P_LEN() { return $FRI_QUERY_STEP_P_LEN; }

function NUM_FRI_QUERY_STEP_V() { return $NUM_FRI_QUERY_STEP_V; }
function FRI_QUERY_STEP_V() {
  var bits[$NUM_FRI_QUERY_STEP_V];
  $SET_FRI_QUERY_STEP_V;
  return bits;
}
function NUM_FRI_QUERY_STEP_P() { return $NUM_FRI_QUERY_STEP_P; }
function FRI_QUERY_STEP_P() {
  var bits[$NUM_FRI_QUERY_STEP_P];
  $SET_FRI_QUERY_STEP_P;
  return bits;
}
